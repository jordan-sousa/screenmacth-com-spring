...
import br.com.jordan.screenmatch.model.*;
...
//        dadosSeries.add(dados);
    ...
    private void filtrarSeriePorTemporadaEAvaliacao() {
        ...
        leitura.nextLine();
        System.out.println("Com avaliação de qual valor?");
        var avaliacao = leitura.nextDouble();
        leitura.nextLine();
        List<Serie> filtroSerie = repositorio.seriePorTemporadaEAvaliacao(totalTemporadas, avaliacao);
    ...
    private void buscarEpisodiosPorData() {
        ...
        if(serieBusca.isPresent()){
            ...
            System.out.println(episodiosAno);
        }
    }
}
